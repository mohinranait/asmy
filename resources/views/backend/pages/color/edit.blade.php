                ...
                <div class="col-sm-6 col-xl-12">
                    <div class="card">
                        <div class="card-header tx-medium">
                           <p class="tx-uppercase mb-0"> Edit Color</p>
                        </div><!-- card-header -->
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-1">
                                                <img src="{{asset('image/' . $color->image)}}" width="30px" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-1">
                                                <div class="coloredit-div" style="background:{{ $color->color_code }}"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="">Status</label>
                                            <label class="rdiobox">
                                                <input name="status" value="1" type="radio"  @if( $color->status == 1) checked @endif >
                                                <span>Active</span>
                                            </label>
                                            <label class="rdiobox">
                                                <input name="status" value="0"  type="radio" @if( $color->status == 0) checked @endif>
                                                <span>In-Active</span>
                                            </label>
                                        </div>
                                    </div>
