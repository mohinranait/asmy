                    ...
                    <div class="card">
                        <div class="card-header tx-medium ">
                            <div class="d-flex justify-content-between">
                                <p class="tx-uppercase mb-0"> User List</p>
                                ...
                                <table class="table table-bordered table-hover mb-2 mg-b-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $key->email }} <br>  Phone : {{ $key->phone}}</td>
                                            <td>
                                                {{ $key->address }} ,  
                                                Zila : {{ $key->districts->name }} <br>
                                                Upzila : {{ $key->upzilas->name  }}

                                            </td>
                                            <td>
                                                @if($key->profile)
                                                <img src="{{asset('image/' . $key->profile)}}" width="40px" alt="">
                                                @else
                                                -N/A-
                                                @endif
                                            </td>
                                            ...
                                            <td class="action">
                                                ...
                                                <a href="{{route('user.edit' , $key->id )}}" class="btn btn-primary btn-sm"><i class="fa fa-edit "></i></a>
                                                        ...
                                                        <div class="modal-dialog modal-sm" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h6 class="modal-title" id="exampleModalLabel">{{$key->name}} user Delete?</h6>
