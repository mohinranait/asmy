                ...
                <div class="col-sm-6 col-xl-12">
                    <div class="card">
                        <div class="card-header tx-medium">
                           <p class="tx-uppercase mb-0"> Edit Brand</p>
                        </div><!-- card-header -->
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="">Status</label>
                                            <label class="rdiobox">
                                                <input name="status" value="1" type="radio"  @if( $brand->status == 1) checked @endif >
                                                <span>Active</span>
                                            </label>
                                            <label class="rdiobox">
                                                <input name="status" value="0"  type="radio" @if( $brand->status == 0) checked @endif>
                                                <span>In-Active</span>
                                            </label>
                                        </div>
                                    </div>
