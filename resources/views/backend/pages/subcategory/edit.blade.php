                ...
                <div class="col-sm-6 col-xl-12">
                    <div class="card">
                        <div class="card-header tx-medium">
                           <p class="tx-uppercase mb-0"> Edit Sub category</p>
                        </div><!-- card-header -->
                        <div class="card-body">
                            ...
                            <form action="{{route('sub.category.update', $category->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label for="">Priamry Category</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <select name="primary_category_id" class="form-control" id="">
                                            ...
                                            <option value="{{$item->id}}" @if( $item->id == $category->primary_category_id ) selected @endif>{{$item->name}}</option>
                                            @endforeach
                                        </select>
